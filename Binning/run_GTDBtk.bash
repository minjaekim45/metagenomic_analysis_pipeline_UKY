...
singularity run --env GTDBTK_DATA_PATH=/gtdbtk_data/database -B $database --app gtdbtk240 $container gtdbtk classify_wf --batchfile $FOLDER/17.checkm/output/good_quality/batchfile.txt --out_dir $FOLDER/18.gtdbtk/ --mash_db ../09.mash/mash.all.msh --extension fa --cpus $THR
